      ...
      {uiState.isEditing ? (
        <>
          ...
          <AutoLayout direction="vertical" spacing={8}>
            ...
            {!uiState.showAvatarSelector ? (
              <AutoLayout
                ...
                stroke="#CCCCCC"
                onClick={() =>
                  setUiState({ ...uiState, showAvatarSelector: true })
                }
              >
                <Image
                  src={getProfileImage(selectedClass as any, level)}
                  width={64}
                  height={64}
                  cornerRadius={8}
                />
                ...
                <AutoLayout direction="vertical" spacing={8}>
                  <AutoLayout spacing={8}>
                    {firstRow.map((c) => (
                      ...
                      >
                        <Image
                          src={getProfileImage(c as any, level)}
                          width={64}
                          height={64}
                          cornerRadius={8}
                        />
            ...
            <Text fontSize={11} fill="#6B7280">
              L'avatar est automatiquement choisi selon la classe.
            </Text>
          </AutoLayout>
              ...
              >
                {classes.map((c) => (
                  <AutoLayout
                    ...
                    onClick={() => {
                      setSelectedClass(c);
                      setUiState({ ...uiState, showClassDropdown: false });
                    }}
                  >
                    <Text>{c}</Text>
                  </AutoLayout>
          ...
          <AutoLayout direction="vertical" spacing={4} width="fill-parent">
            ...
            >
              <Text width="fill-parent">
                {getTitleFor(selectedClass as any, level)}
              </Text>
            </AutoLayout>
          </AutoLayout>
          ...
          <AutoLayout
            ...
            onClick={() => setUiState({ ...uiState, isEditing: false })}
          >
